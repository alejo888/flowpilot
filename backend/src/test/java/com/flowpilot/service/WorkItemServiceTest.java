 ...
 * gated by {@code isOwnerOrAdmin} — the same interim rule used by {@code
 * ProjectService}/{@code ProjectMemberService} writes (confirmed decision 5b
 * interim rule, slices 3-6). Reads are gated by {@code canView}. Create

...
public class CommentService {
 ...
 public List<CommentResponse> listProject(Long projectId,Long userId,int limit,int offset){requireProject(projectId); requireView(userId,projectId); return page(comments.findByProjectIdAndWorkItemIdIsNullOrderByCreatedAtDescIdDesc(projectId),limit,offset);}
